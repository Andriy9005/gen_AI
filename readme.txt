...
Перелік релевантних файлів/папок на Github: 
  ...
  -> trained_models - натреновані LLM моделі, які перекладають текст
  -> training_inputs - скрипти для обєднання дата-сету для тренування LLM, лінки на джерело відкритого дата-сету 
  Файли: 
